...
public class HotelResult implements Serializable{
    ...
    /**
     * 将json结果集转化为HotelResult对象
     *
     * @param jsonData
     *            json数据
     * @param clazz
     *            HotelResult中的object类型
     * @return
     */
    public static HotelResult formatToPojo(String jsonData, Class<?> clazz) {
        try {
            if (clazz == null) {
                return MAPPER.readValue(jsonData, HotelResult.class);
            }
     ...
     * @return
     */
    public static HotelResult format(String json) {
        try {
            return MAPPER.readValue(json, HotelResult.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
     ...
     * @return
     */
    public static HotelResult formatToList(String jsonData, Class<?> clazz) {
        try {
            JsonNode jsonNode = MAPPER.readTree(jsonData);
            JsonNode data = jsonNode.get("data");
            Object obj = null;
